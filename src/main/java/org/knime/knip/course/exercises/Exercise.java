...
public class Exercise< T extends RealType< T > & NativeType< T > > implements Command
{
	...
	public void run()
	{
		// TODO Add sc.fiji.Colocalisation_Analysis as dependency in POM.xml
		...
		// Coloc_2 shows a user interface if java.awt.headless is false. To not
		// show this window, set the system property.
